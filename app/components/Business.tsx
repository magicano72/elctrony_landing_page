...
const Business = () => (
  <section id="features" className="section">
    ...
    >
      ...
      With Electrony, you can streamline your document workflow by signing digitally, saving time, and ensuring security. No need for printing, scanning, or physical paperwork—just sign, save, and share in seconds!
      </p>
